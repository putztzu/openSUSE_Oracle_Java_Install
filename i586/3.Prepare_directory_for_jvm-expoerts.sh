mkdir /usr/lib/jvm-exports/jdk_Oracle &&
cd /usr/lib/jvm-exports/jdk_Oracle &&
ln -s /usr/lib/jdk_Oracle/jre/lib/rt.jar jaas-1.7.0_Orac.jar &&
ln -s jaas-1.7.0_Orac.jar jaas-1.7.0.jar &&
ln -s jaas-1.7.0_Orac.jar jaas.jar &&
ln -s /usr/lib/jdk_Oracle/jre/lib/jce.jar jce-1.7.0_Orac.jar &&
ln -s jce-1.7.0_Orac.jar jce-1.7.0.jar &&
ln -s jce-1.7.0_Orac.jar jce.jar &&
ln -s /usr/lib/jdk_Oracle/jre/lib/rt.jar jdbc-stdext-1.7.0_Orac.jar &&
...
ln -s /usr/lib/jdk_Oracle/jre/lib/rt.jar jndi-1.7.0_Orac.jar &&
ln -s jndi-1.7.0_Orac.jar jndi-1.7.0.jar &&
ln -s /usr/lib/jdk_Oracle/jre/lib/rt.jar jndi-cos-1.7.0_Orac.jar &&
